...
<?php if ( get_theme_mod('shopfront_ecommerce_preloader', true) != "") { ?>
  <div id="preloader">
    <div id="status">&nbsp;</div>
  </div>
<?php } ?>
...
<?php if ( get_theme_mod('shopfront_ecommerce_top_bar', false) != "") { ?>
      ...
      <div class="col-lg-3 col-md-8 align-self-center">
        <div class="logo">
          ...
          <div class="site-branding-text">
            <?php if ( get_theme_mod('shopfront_ecommerce_title_enable',true) != "") { ?>
