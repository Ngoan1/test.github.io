		...
		function render_content() {
			...
			<div class="pro_info">
				<ul>
					...
					<li><a class="upgrade-to-pro" href="<?php echo esc_url( SHOPFRONT_ECOMMERCE_PREMIUM_PAGE ); ?>" target="_blank"><i class="dashicons dashicons-cart"></i><?php esc_html_e( 'Upgrade Pro', 'shopfront-ecommerce' ); ?> </a></li>
