	...
	function ecommerce_store_elementor_footer_copyright() {
		...
		<div class="colophon-inner">
		    ...
		    <?php if ( ! empty( $ecommerce_store_elementor_powered_by_text ) ) : ?>
			    <div class="colophon-column">
			    	<div class="site-info">
					<a href="<?php echo esc_url('https://www.mizanthemes.com/elementor/free-ecommerce-wordpress-theme/','ecommerce-store-elementor'); ?>"><?php echo $ecommerce_store_elementor_powered_by_text; ?></a>
			    	</div><!-- .site-info -->
			    </div><!-- .colophon-column -->
		    <?php endif; ?>
		</div><!-- .colophon-inner -->
