...
if ( ! defined( 'AUTHOR_WRITER_THEME_BUNDLE' ) ) {
    define( 'AUTHOR_WRITER_THEME_BUNDLE', 'https://www.themespride.com/themes/wordpress-theme-bundle/' );
}
...
function author_writer_about_display() {
	...
	<div class="wrap about-wrap full-width-layout">
		...
		<nav class="nav-tab-wrapper wp-clearfix" aria-label="<?php esc_attr_e( 'Secondary menu', 'author-writer' ); ?>">
			...
			<a href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'author-writer-about', 'tab' => 'get_bundle' ), 'themes.php' ) ) ); ?>" class="blink wp-bundle nav-tab<?php echo ( isset( $_GET['tab'] ) && 'get_bundle' === $_GET['tab'] ) ?' nav-tab-active' : ''; ?>"><?php esc_html_e( 'Get WordPress Theme Bundle', 'author-writer' ); ?></a>
		</nav>
	...
	?>
		<div class="feature-section two-col">
			...
			<div class="col card">
				...
				<p><a href="<?php echo esc_url( AUTHOR_WRITER_SUPPORT_THEME_URL ); ?>" class="button button-primary"target="_blank"><?php esc_html_e( 'Support Forum', 'author-writer' ); ?></a></p>
			</div>
			...
			<div class="col card">
				...
				<button class="button button-primary"><?php esc_html_e( 'GETPro20', 'author-writer' ); ?></button>
			</div>
		</div>
	<?php
	}
				...
				<table>
					...
					<tbody>
						...
						<tr class="odd" scope="row">
							...
							<td class="feature feature--empty"></td>
							<td headers="comp-2" class="td-btn-2"><a href="<?php echo esc_url( AUTHOR_WRITER_PRO_THEME_URL ); ?>" class="sidebar-button single-btn" target="_blank"><?php esc_html_e( 'Go for Premium', 'author-writer' ); ?></a></td>
						</tr>
					</tbody>
				</table>
			</div>
...
function author_writer_get_bundle() {
	if ( isset( $_GET['tab'] ) && 'get_bundle' === $_GET['tab'] ) {
	?>
		<div class="wrap about-wrap">

			<p class="about-description"><?php esc_html_e( 'Get WordPress Theme Bundle', 'author-writer' ); ?></p>
			<div class="col card">
				<h2 class="title"><?php esc_html_e( ' WordPress Theme Bundle of 65+ Themes At 15% Discount. ', 'author-writer' ); ?></h2>
				<p><?php esc_html_e( 'Spring Offer Is To Get WP Bundle of 65+ Themes At 15% Discount use the coupon', 'author-writer' ) ?>"<input type="text" value=" TPRIDE15 "  id="myInput">".</p>
				<p><a target="_blank" href="<?php echo esc_url( AUTHOR_WRITER_THEME_BUNDLE ); ?>" class="button button-primary"><?php esc_html_e( 'Theme Bundle', 'author-writer' ); ?></a></p>
			</div>
		</div>
	<?php
	}
