      ...
      <div class="col-lg-3 col-md-4 align-self-center">
        <div class="book-tkt-btn my-4 my-md-0 text-center text-md-end">
          <?php if( get_theme_mod( 'author_writer_sign_in_link' ) != '' || get_theme_mod( 'author_writer_sign_in_button' ) != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'author_writer_sign_in_link','' ) ); ?>" class="register-btn me-3"><?php echo esc_html( get_theme_mod( 'author_writer_sign_in_button','' ) ); ?></a>
          <?php } ?>
